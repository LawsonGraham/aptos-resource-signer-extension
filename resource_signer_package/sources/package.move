...
module resource_signer_package::package {
    ...
    //                                                                        //
    const DEPLOYER_ADDRESS: address = @resource_signer_package_deployer;
    const RESOURCE_ACCOUNT_SEED: vector<u8> = b"resource_signer_package";
    const RESOURCE_ACCOUNT_ADDRESS: address = @resource_signer_package;
    //                                                                        //
    //                                                                        //
    //                                                                        //
    // *************************************************************************
    ...
    struct SignerKey has key, store {}
    ...
    public fun create_signer_key(manager: &signer): SignerKey {
        assert!(thala_manager::manager::is_authorized(manager), ERR_PACKAGE_UNAUTHORIZED);
        SignerKey {}
    }

    public fun resource_account_signer_with_key(signer_key: &SignerKey): signer acquires ResourceSignerCapability {
