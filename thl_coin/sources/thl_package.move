...
module thl_coin::thl_package {
    ...
    //                                                                        //
    const DEPLOYER_ADDRESS: address = @thl_coin_deployer;
    const RESOURCE_ACCOUNT_SEED: vector<u8> = b"thl_coin";
    const RESOURCE_ACCOUNT_ADDRESS: address = @thl_coin;
    //                                                                        //
    //                                                                        //
    //                                                                        //
    // *************************************************************************
